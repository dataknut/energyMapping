...
```
### Difference in proportion Fuel Poverty 2012 to 2018 (2nd half is BROKEN!)
...
##BROKEN
merged_dfla$LA11CD <- merged_dfla$”LA Code” # Creating a variable with the local authority code in the same name 
