...
la_fuelpov_2019$lad18cd <- la_fuelpov_2019$`Area Codes` # Creating a variable with the local authority code in the same name 
...
### Actual Difference between 2012-2019
```{r Loading in the difference data}
...
###Difference in proportion between 2012-2019
