...
census_age$'Local Authority Code'<- census_age$'geography code'
head(census_age)
names(census_age)
```
```{r Mapping the fuel poverty in over 65s}
#census_age$"LSOA11CD" <- census_age$"geography code"
Census_age_fp <- merge(lsoa_fuelpov_2019_merged, census_age)
names(Census_age_fp)
ggplot(Census_age_fp, aes(x='Proportion Over 65', y=pcFP)) 
