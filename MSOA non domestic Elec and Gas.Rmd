...
ndelec_msoa_2010$ndelec2010 <-ndelec_msoa_2010$' Mean consumption (kWh per meter)'                                       
ndelec_msoa_2019$ndelec2019 <-ndelec_msoa_2019$' Mean consumption (kWh per meter) '
merged_nondomelec <-merge(ndelec_msoa_2010, ndelec_msoa_2019, by = "Middle Layer Super Output Area (MSOA) Code", all=TRUE)
names(merged_ndelec)
merged_ndelec$ndelec_diff<-as.numeric(merged_ndelec$ndelec2019) - as.numeric(merged_ndelec$ndelec2010) ##BROKEN
summary(merged_ndelec)
```
...
ggplot2::ggplot(msoa_nd20102019) +
  geom_sf(aes(fill=" Mean consumption (kWh per meter)"))+ 
