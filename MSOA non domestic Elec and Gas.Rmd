...
merged_ndgas20102019$ndgas_diff<-merged_ndgas20102019$ndgas2019 - merged_ndgas20102019$ndgas2010 ##BROKEN
summary(merged_ndgas20102019)
```

```{r Mapping the change in non domestic gas usage in the MSOA}
merged_ndgas20102019$MSOA11CD <- merged_df$"Middle Layer Super Output Area (MSOA) Code" #creating a variable with the LSOA code in the same name as in sf_data
msoa_ndgas20102019 <- merge(msoa_sf_data, merged_ndgas20102019) #merging these
