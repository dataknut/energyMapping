...
names(merged_ndelec)
merged_ndelec$ndelec_diff<-merged_ndelec$ndelec2019 - merged_ndelec$ndelec2010 ##BROKEN
summary(merged_ndelec)
```
...
nondomgas_msoa_2010 <-readr::read_csv(paste0(dataFolder,"/energy/gas/MSOA NonDom Gas csv/MSOA_NonDom_Gas_2010.csv"))
nondomgas_msoa_2019<-readr::read_csv(paste0(dataFolder,"energy/gas/MSOA NonDom Gas csv/MSOA_NonDom_Gas_2019.csv"))
