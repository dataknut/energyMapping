...
domelec_LSOA_2019$LSOA11CD <- domelec_LSOA_2019$`Lower Layer Super Output Area (LSOA) Name`
...
cor(Solent_2019$prop_65m, Solent_2012$mean_de2019)
```
...
```{r Graphing over 65s against gas consumption}
#census_age$"LSOA11CD" <- census_age$"geography code"
domgas_LSOA_2019$`Lower Layer Super Output Area (LSOA) Code` <- domgas_LSOA_2019$`LSOA Code`

Census_age_2012fp <- merge(domgas_LSOA_2019, census_age, by = "Lower Layer Super Output Area (LSOA) Code")
# select the variables we want for clarity
